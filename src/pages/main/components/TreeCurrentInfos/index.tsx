      ...
      <Flex css={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
        <Flex css={{ flexDirection: 'column', alignItems: 'flex-end', marginBottom: 4 }}>
          <Flex css={{ alignItems: 'center', marginBottom: 4 }}>
            ...
            />
            <Text variant={"caption"} css={{ color: '$interface_dark_down' }}>Corrente em A (RMS)</Text>
          </Flex>
        ...
        <Flex css={{ flexDirection: 'column', alignItems: 'flex-end', marginBottom: 4 }}>
          <Flex css={{ alignItems: 'center', marginBottom: 4 }}>
            ...
            />
            <Text variant={"caption"} css={{ color: '$interface_dark_down' }}>Corrente em B (RMS)</Text>
          </Flex>
          <Flex css={{ alignItems: 'flex-end' }}>
        ...
        <Flex css={{ flexDirection: 'column', alignItems: 'flex-end', marginBottom: 4 }}>
          <Flex css={{ alignItems: 'center', marginBottom: 4 }}>
            ...
            />
            <Text variant={"caption"} css={{ color: '$interface_dark_down' }}>Corrente em C (RMS)</Text>
          </Flex>
          <Flex css={{ alignItems: 'flex-end' }}>
